...
import * as quarantineLotService from "../../service/inventory/quarantine-lot-service";
...
const getAll = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    const result = await quarantineLotService.getAll(filter, page, limit, {
      search: query.search,
      status: query.status,
...
const get = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    const result = await quarantineLotService.get(req.params.id, filter);
