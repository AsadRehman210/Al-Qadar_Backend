...
import { create, getAll, get, update, deleteByID } from "../../controller/payroll/special-payment-type-controller";
import { verifyToken } from "../../../middleware/auth";
import { requireRole } from "../../../middleware/role";
import { AccountRole } from "../../utility/helper/constants/enum";

const specialPaymentTypeRoute = Router();
...
export default specialPaymentTypeRoute;
