...
import { get, upsert } from "../../controller/finance/vat-config-controller";
import { verifyToken } from "../../../middleware/auth";
import { requireRole } from "../../../middleware/role";
import { AccountRole } from "../../utility/helper/constants/enum";

const vatConfigRoute = Router();
...
vatConfigRoute
  ...
  .put("/", verifyToken, canWrite, upsert);

export default vatConfigRoute;
